...
{
 $a= json_decode(file_getsuper_contents("https://learn.mathongo.com/s/mycourses/get?skip=0&limit=15&queryData=%7B%7D&isVerticalFilters=true&categoryLevel=0&archived=false", getBaseHeaders()), true);
return $a;
}
